...
user_info=dir('C:\Users\l*');this_user=user_info.name
pause
%--------------------------------------------------------------------------
% Create Log File
%--------------------------------------------------------------------------
...
OutPathStr=strcat('C:\Users\',this_user,'\Dropbox\NYSTROM_MATLAB_CODE\Nystom_Modified_Method\EventDetector1.0\Results\FindTheEndOfReading\2\');
fprintf('OutPathStr = \n%s\n',OutPathStr);
...
if MsecEndOfReading_1 == MsecEndOfReading_2 && MsecEndOfReading_1== MsecEndOfReading_3
    OutPathStr=strcat(OutPathStr,'All_Equal\');
elseif MsecEndOfReading_1 ~= MsecEndOfReading_2 && MsecEndOfReading_2 ~= MsecEndOfReading_3  && MsecEndOfReading_1 ~= MsecEndOfReading_3 
    OutPathStr=strcat(OutPathStr,'All_Different\');
elseif MsecEndOfReading_1 < MsecEndOfReading_2 && MsecEndOfReading_1 < MsecEndOfReading_3  
    OutPathStr=strcat(OutPathStr,'1isFirst\');
elseif MsecEndOfReading_2 < MsecEndOfReading_3 && MsecEndOfReading_2 < MsecEndOfReading_1  
    OutPathStr=strcat(OutPathStr,'2isFirst\');
elseif MsecEndOfReading_3 < MsecEndOfReading_1 && MsecEndOfReading_3 < MsecEndOfReading_2  
    OutPathStr=strcat(OutPathStr,'3isFirst\');
elseif MsecEndOfReading_1 == MsecEndOfReading_3 && MsecEndOfReading_1 ~= MsecEndOfReading_2
    OutPathStr=strcat(OutPathStr,'1_and 3_Equal\');
elseif MsecEndOfReading_2 == MsecEndOfReading_3 && MsecEndOfReading_2 ~= MsecEndOfReading_1  
    OutPathStr=strcat(OutPathStr,'2_and_3_Equal\');
elseif MsecEndOfReading_1 == MsecEndOfReading_3 && MsecEndOfReading_1 ~= MsecEndOfReading_2  
    OutPathStr=strcat(OutPathStr,'1_and_3_Equal\');
end
fprintf('OutPathStr = \n%s\n',OutPathStr);
if ~exist(OutPathStr,'dir'), mkdir(OutPathStr),end;
...
FigureHandle.InvertHardcopy = 'off';
OutPathStr=strcat(OutPathStr,'CRIT\');
if ~exist(OutPathStr,'dir'), mkdir(OutPathStr),end;
